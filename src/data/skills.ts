  ...
  techStacks: [
    {
      ...
      description:
        'Hypertext Markup Language (HTML) is the standard markup language for structuring content on the web, forming the backbone of web pages and applications. I self-taught HTML during my final year of high school, driven by a curiosity to how the web works and want to create my own website.',
    },
    {
      name: 'CSS',
